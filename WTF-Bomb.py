...
\033[1;31m---------------------------------------
\033[1;35mCODED BY   : \033[33mGtajisan 
\033[1;35mGITHUB     : \033[1;33mgithub.com/Gtajisan 
\033[1;35mTeam Name  : \033[1;33mNewb Gang V18rs 
\033[1;35mFACEBOOK   : \033[1;33mSorry Dude We Are Anonymous. So No FB
\033[1;31m---------------------------------------
"""
...
def sms_bombing():
    ...
    for sms in range(limit):
        ...
        print "\033[1;31m--------------------------"
        if sms_limit == limit:
           os.system('xdg-open https://github.com/Gtajisan ')
def intro():
    os.system('clear')
    print logo
    print ""
    ...
    print ""
    user_choise = raw_input("\033[1;34mV-BOMB \033[1;31m>>  ")
    if user_choise == "1":
       sms_bombing()
    elif user_choise == "2":
         os.system('xdg-open https://github.com/Gtajisan/WTF-Bomb')
         os.system('xdg-open https://github.com/Gtajisan/WTF-Bomb')
    elif user_choise == "3":
         os.system('clear')
